...
- Missing application code: CI files, Filament dashboard, public website pages, localization/theme implementation, sitemap/robots, and frontend API consumption.
...
- Filament, Sanctum, Spatie Permission, and media packages are not installed yet.
