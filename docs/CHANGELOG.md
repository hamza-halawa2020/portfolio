...
- FND-005 is blocked until Herd PHP is executable from the active shell, MySQL 8.4 LTS is available or an approved alternative is documented, and Redis or Valkey is installed and reachable.
